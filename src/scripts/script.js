...
const products = [
  ...
  { id: 7, title: "Мужские Кроссовки Jordan Air Jordan 11", price: "64 699 тг.", img: "../assets/products/jordan-air-jordan-11.jpg", liked: "../assets/icons/umliked.svg", cart: "../assets/icons/addedcart.svg" },
  { id: 8, title: "Мужские Кроссовки Nike LeBron XVIII", price: "99 990 тг.", img: "../assets/products/nike-lebron-xviii.jpg", liked: "../assets/icons/umliked.svg", cart: "../assets/icons/addedcart.svg" },
  { id: 9, title: "Мужские Кроссовки Nike Lebron XVIII Low", price: "83 399 тг.", img: "../assets/products/nike-lebrom-xvii-low.jpg", liked: "../assets/icons/umliked.svg", cart: "../assets/icons/addedcart.svg" },
  { id: 10, title: "Мужские Кроссовки Nike Blazer Mid Suede", price: "51 990 тг.", img: "../assets/products/nike-blazer-mid-suede-green.jpg", liked: "../assets/icons/umliked.svg", cart: "../assets/icons/addedcart.svg" },
  { id: 11, title: "Кроссовки Puma X Aka Boku Future Rider", price: "53 990 тг.", img: "../assets/products/aka-boku-future-rider.jpg", liked: "../assets/icons/umliked.svg", cart: "../assets/icons/addedcart.svg" },
  { id: 12, title: "Мужские Кроссовки Nike Kyrie Flytrap IV", price: "67 990 тг.", img: "../assets/products/nike-kyrie-flytrap-iv.jpg", liked: "../assets/icons/umliked.svg", cart: "../assets/icons/addedcart.svg" }
];

// 3-4 клетка или контейнер также из игрушек вродебы чтоб был контейнер
const cardsContainer = document.querySelector(".cards");
if (!cardsContainer) {
  console.error("Контейнер .cards не найден. Убедись, что в HTML есть <div class='cards'> ...</div>");
}

// взял тоже из игрушек вроде бы чтоб при проблемах отрисовывался
...
// поиск хз рабоает вроде да из другого кода по игрушкам взял
